...
const CreatePost = () => {
  ...
  // FIXED: Safely parse localStorage data with error handling
  const loginData = JSON.parse(localStorage.getItem("loginData") || "{}");
  
  // FIXED: Handle authData safely - it might not be an array
  let userName = "";
  try {
    ...
    // Find current user if loginData exists
    if (loginData?.email) {
    ...
    userName = loginData?.email ? loginData.email.split("@")[0] : "";
  }
